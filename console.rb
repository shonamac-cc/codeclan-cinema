...
ticket8 = Ticket.new({ 'customer_id' => customer2.id, 'screening_id' => screening4.id})
ticket9 = Ticket.new({ 'customer_id' => customer3.id, 'screening_id' => screening4.id})
ticket10 = Ticket.new({ 'customer_id' => customer1.id, 'screening_id' => screening4.id})
ticket11 = Ticket.new({ 'customer_id' => customer3.id, 'screening_id' => screening5.id})
ticket12 = Ticket.new({ 'customer_id' => customer2.id, 'screening_id' => screening5.id})
ticket13 = Ticket.new({ 'customer_id' => customer1.id, 'screening_id' => screening6.id})
ticket14 = Ticket.new({ 'customer_id' => customer2.id, 'screening_id' => screening6.id})
